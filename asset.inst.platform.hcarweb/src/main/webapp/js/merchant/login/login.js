...
require(['jquery', 'base', 'formatter', 'common', 'validate'], function($, Base, Formatter, Common, Validate){
    ...
    /** 验证手机号 **/
    function validateMerchantNo(id){
    	var eId = '#' + id;
    ...
    function validateForm(){
    	return validateMerchantNo('merchantNo') && validatePwd('password');
    }
    ...
    function submitLoginForm(){
    	setIsAutoLogin();
    	Base.post(Base.url.rootUrl + '/unIntcpt-req/login/merchant', $('#loginForm').serializeObject(), function(result){
			Base.loadingOut();
			Base.redirectUrl('../merchantCenter/merchantCenter.html');
		});
    }
