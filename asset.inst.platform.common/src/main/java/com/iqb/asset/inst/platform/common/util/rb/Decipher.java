package com.iqb.asset.inst.platform.common.util.rb;
...
import com.iqb.asset.inst.platform.common.util.rb.AES;
import com.iqb.asset.inst.platform.common.util.rb.RSA;
...
public class Decipher {
     ...
     */
    public static String decryptData(String post, String priKeyUrl, String priKeyPwd) throws Exception {
        ...
        // 获取自己私钥解密
        PrivateKey pvkformPfx = RSA.getPvkformPfx(priKeyUrl, priKeyPwd);//私钥路径
     ...
     * @throws com.reapal.common.exception.ServiceException
     */
    public static Map<String, String> encryptData(String json, String rbPubKeyUrl) throws Exception {
        System.out.println("json数据=============>" + json);

        // 商户获取融宝公钥
        PublicKey pubKeyFromCrt = RSA.getPubKeyFromCRT(rbPubKeyUrl);
        // 随机生成16数字
